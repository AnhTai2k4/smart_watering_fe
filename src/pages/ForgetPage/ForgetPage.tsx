      ...
      <div className="forget-password-content">
        {step === "sendOTP" && (
          <>
            ...
            <h2 className="otp-title">Quên mật khẩu</h2>
            <p className="otp-description">Nhập email của bạn để nhận mã xác thực</p>
        ...
        {step === "verifyOTP" && (
          <>
            ...
            <p className="otp-description">Mã OTP đã được gửi đến email</p>
