        ...
        <div className="data-group-page">
            <div className="data-group-page__inner">
                <header className="data-group-page__header">
                    <div>
                        <h1 className="data-group-page__title">
                            Nhóm: {groupName}
                        </h1>
                ...
                <div className="data-group-page__toolbar">
                    ...
                    <div className="dropdown">
                        <button className="dropdown-toggle data-group-sort-btn" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <span className="data-group-sort-btn__icon">↕</span>
                            <span>{sortLabel}</span>
                        </button>
                        <ul className="dropdown-menu">
                            <li><a className="dropdown-item" href="#" onClick={() => handleSort("", "Sắp xếp")}>Mặc định</a></li>
                            <li><a className="dropdown-item" href="#" onClick={() => handleSort("name", "Theo tên")}>Theo tên</a></li>
                            <li><a className="dropdown-item" href="#" onClick={() => handleSort("updatedAt", "Ngày cập nhật")}>Ngày cập nhật</a></li>
                            <li><a className="dropdown-item" href="#" onClick={() => handleSort("online", "Đang online")}>Đang online</a></li>
                        </ul>
                    </div>

                    <div className="dropdown">
                        <button className="dropdown-toggle data-group-actions-btn" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <span className="data-group-sort-btn__icon">⋯</span>
                            <span>Thao tác</span>
                        </button>
                        <ul className="dropdown-menu">
                    ...
                    <div className="dropup-center dropup dropup__container">
                        ...
                        <ul className="dropdown-menu">
                            ...
                            <li>
                                <a
                                    className="dropdown-item"
                                    onClick={()=>navigate(`/schedule_group_page?groupId=${id}&groupName=${groupName}`)}   
                                >
                                    Bơm đồng thời
                                </a>
                            </li>
