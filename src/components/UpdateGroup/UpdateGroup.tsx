...
const UpdateGroup = ({ groupId }: { groupId: string }) => {
  ...
  const handleUpdateGroup = async (e: React.MouseEvent<HTMLButtonElement>) => {
    e.preventDefault();
    if (!groupName.trim()) {
    ...
    try {
      const token = localStorage.getItem("token");
      const apiUrl = `${import.meta.env.VITE_BE_URL}/groups/${groupId}`;
      ...
      alert("Có lỗi xảy ra khi sửa nhóm");
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="modal-dialog modal-dialog-centered modal-lg">
        <div className="modal-content create-group-modal">
          <div className="create-group-header">
            <h1 className="create-group-title">Sửa nhóm thiết bị</h1>
            <button
              type="button"
          ...
          <div className="create-group-body">
            <p className="create-group-description">
              Sửa tên nhóm và chọn thiết bị mới thêm vào nhóm
            </p>

            <div className="create-group-form">
              <label className="create-group-label">Tên nhóm mới</label>
              <input
                type="text"
            ...
            <div className="create-group-device-section">
              <label className="create-group-label">Chọn thiết bị mới</label>
